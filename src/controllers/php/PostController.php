...
class PostController {
    ...
    public function index() {
        try {
            ...
            // --- HYBRID CACHE START ---
            $cacheKey = 'posts_' . md5(serialize($_GET) . $page . $perPage . $type);
            ...
            Cache::set($cacheKey, $formatted, 60); // Store locally for 60s
            Response::json($formatted, 200, 60); // Send to CDN for 60s
    ...
    public function show($id) {
        ...
        Response::json($formatted, 200, 60);
    }
    ...
    public function create() {
        ...
        try {
            ...
            Cache::clear(); // Invalidate local cache
            $this->show($id);
